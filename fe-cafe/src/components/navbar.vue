      ...
      >
        <div>
          <a class="navbar-brand brand-logo">
            <img src="https://kopen.coffee/wp-content/uploads/2022/05/kopen-logo.png" alt="logo" />
          </a>
        ...
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">
              <span class="fw-bold" style="color:orange"
                >Selamat Datang, {{ user.name }}</span
              >
            </h1>
            <h3 class="welcome-sub-text">Koopen Cafe</h3>
          </li>
        </ul>
